                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                                <div className="flex items-center">
                                                    {apprentices.map((user, idx) => (
                                                        <img key={idx} className="w-6 h-6 transform border border-gray-200 rounded-full cursor-pointer hover:scale-125" src={`storage/${user.photo}`} />
                                                    ))}
                                                </div>
                                            </td>
                                            <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                <InertiaLink href={route('submission.show', id.toString())} className="text-gray-600 hover:text-gray-900">
                                                    Detail
                                                </InertiaLink>
                                            </td>
                                        </tr>
