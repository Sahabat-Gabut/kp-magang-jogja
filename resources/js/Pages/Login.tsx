        ...
        <>
            <main className="flex-col my-10">
                <div className="col-span-6 text-center">
                    ...
                    <h4 className="italic">Jika belum punya akun Jogja Smart Service silahkan Register <a className="underline text-emerald-600" href="https://jss.jogjakota.go.id/homepage?register=true">disini</a></h4>
                </div>
            </main>
                    ...
                    <div className="flex justify-center w-full">
                        <div className="flex w-1/2 bg-white divide-y divide-gray-200 rounded-md shadow">
                            <form className="w-full px-5 py-7" onSubmit={formHandler}>
                                ...
                                <label className="block pb-1 mt-5 text-sm font-semibold text-gray-600">Kata Kunci</label>
                                <input type="password"
                                    value={password}
                                ...
                                <button type="submit" className={`mt-5 transition duration-200 bg-green-600 hover:bg-green-700 focus:bg-green-700 focus:shadow-sm focus:ring focus:ring-green-600 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block`} disabled={processing}>
