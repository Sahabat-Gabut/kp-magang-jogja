    ...
    return (
        <>
            <div className="flex items-center gap-2 mt-10 mb-5 rounded-lg">
                <SearchFilter />
                <button onClick={() => setAddOpen(true)} className="flex items-center gap-2 px-3 py-2 text-gray-800 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none">
                                        ...
                                        <tr key={key} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                <div className="flex justify-end gap-2">
                                                    <button onClick={() => _onClick(id, jss.id, role.id, agency_id)} className="font-semibold text-yellow-600 outline-none hover:text-yellow-900 focus:outline-none">
                                                        Ubah
                                                    </button>
            ...
            <Confirm
                ...
                {auth.user?.admin.role.id === 1 && (
                    <>
                        <label htmlFor="agency_id" className="block pb-1 mt-2 text-sm font-semibold text-gray-600">Dinas</label>
                        <select
                            id="agency_id"
                            onChange={(e) => _onChange(e)}
                            name="agency_id"
            ...
            <Confirm
                ...
                onConfirm={() => put(route('admin.update', edit.id))}
                confirmText="Ubah">
            ...
            <Confirm
                ...
                onConfirm={() => adminForm.delete(route('admin.destroy', adminForm.data.id))}
                confirmText="Hapus Admin"
                confirmClass="bg-red-600 hover:bg-red-700 focus:ring-red-500 text-white">
                <p className="text-sm">
                    Apakah kamu yakin ingin menghapus admin ini? Data yang sudah dihapus tidak akan bisa dikembalikan kembali.
                </p>
            </Confirm>
        </>
    )
...
Admin.layout = (page: React.ReactChild) => <AppLayout children={page} />;
