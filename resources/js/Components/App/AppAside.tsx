    ...
    return (
        <aside className="flex-col hidden w-64 overflow-y-auto rounded-md lg:flex">
            <div className="py-4 text-gray-500 dark:text-gray-400">
                ...
                <Popover className="relative px-6 pb-20 flex flex-col justify-end">
                    {({open}) => (
                        <>
                            <Popover.Button
                                className="flex items-center group gap-2 focus:outline-none py-1 justify-between">
                                <div className={'flex items-center gap-2'}>
                                    ...
                                    <span
                                        className="flex font-medium items-center justify-center tracking-tight text-sm text-gray-900">
                                        {auth.user?.username}
                                    </span>
                            ...
                            <Transition as={Fragment}
                                ...
                                <Popover.Panel
                                    className="absolute z-50 mx-auto overflow-hidden bg-white border border-gray-200 rounded-lg shadow-sm left-0 right-0 w-full bottom-0"
                                    style={{width: '14rem', bottom: 0}}>
                                    {auth.user && (
