...
const FormikJSS = ({label, readOnly, hidden, index, ...props}: Props) => {
    ...
    return (
        <div className="w-full">
            <label htmlFor={`jss_id_${props.name}`} className="block pb-1 mt-2 text-sm font-semibold text-gray-600">ID
                JSS</label>
            <div className="relative w-full">
                <div className="flex">
                    <button type="button" onClick={() => findJSS()}
