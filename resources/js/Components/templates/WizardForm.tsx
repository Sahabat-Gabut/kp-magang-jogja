import { Debug } from '@/Pages/Submission/components/Debug';
...
const WizardForm = ({ children, initialValues, onSubmit }: Props) => {
                    ...
                    <div className="flex justify-center w-full">
                        <div className="container max-w-screen-xl">
                            <div className="relative w-full -mt-16 bg-white border shadow-lg rounded-xl">
                                <div className="sticky z-30 flex items-center justify-between px-5 py-4 border-b rounded-t-xl bg-gray-50 top-16 md:top-17">
                                ...
                                <div className={step.props.stepName === "Review Formulir" ? 'p-0' : 'p-5'}>
                                    <Form>
                                        ...
                                        <div className="flex justify-end mt-16">
                                            ...
                                            <div className={step.props.stepName === "Review Formulir" ? 'flex p-5' : 'flex p-0'}>
                                                {stepNumber > 0 && (
                                                    <button
                                                        type="button"
