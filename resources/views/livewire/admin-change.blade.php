<div x-data="{ open: false }">
    <button @click="open = true" class="bg-white text-gray-600 hover:bg-yellow-200 hover:text-yellow-600 border border-r-0 border-gray-300 rounded-l-md px-4 py-2 mx-0 outline-none">
