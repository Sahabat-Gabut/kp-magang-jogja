<div x-data="{ open: false }">
    <button class="bg-green-500 text-white px-4 py-1 rounded-md focus:outline-none flex ml-auto mb-4" @click="open = true">Beri Nilai</button>
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2 w-full">
                                    <input type="number" wire:model="score" class="border @error('score') border-red-500 @enderror focus:outline-none p-2 focus:ring-green-500 focus:border-green-500 flex-1 block w-full rounded-md sm:text-sm" placeholder="0 - 100"/>
