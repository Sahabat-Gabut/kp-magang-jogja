<div x-data="{ open: false }">
    <button class="bg-white text-gray-600 hover:bg-yellow-200 hover:text-yellow-600 border border-r-0 border-gray-300 rounded-l-md px-4 py-2 mx-0 outline-none focus:outline-none" @click="open = true">
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mx-auto max-w-sm text-center flex flex-col justify-centermt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="flex mt-4">
                                    ...
                                    <div class="flex items-center mr-4 mb-4">
                                        <input wire:model="status" id="telat{{$index}}" type="radio" name="status" value="TELAT" class="hidden" />
                                        <label for="telat{{$index}}" class="flex items-center cursor-pointer">
                                            <span class="w-4 h-4 inline-block mr-1 rounded-full border border-grey"></span>
                                            Telat
                                        </label>
                                    </div>
