<form wire:submit.prevent="store">
    <h1 class="text-2xl font-bold mb-4 text-gray-600">{{ $progress->name }}</h1>
    ...
    <footer class="flex justify-end">
        <button class="rounded-md px-3 py-1 bg-white hover:bg-gray-200 text-gray-700 border border-gray-300 cursor-pointer focus:shadow-outline focus:outline-none mr-2" onclick="location.href='/project/detail/{{$progress->project_id}}'">
            {{ __('Kembali') }}
        </button>
