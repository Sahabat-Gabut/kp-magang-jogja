...
<body class="antialiased">
    <div class="flex justify-center min-h-screen bg-white">
        <div
            class="flex flex-col justify-between w-full min-h-screen bg-gradient-to-br from-green-700 via-green-900 to-green-800">
            ...
            <div class="p-5 lg:p-20">
                <div class="flex-1">
                    <div class="mb-4 leading-relaxed lg:leading-10">
                        <h1 class="text-sm font-black tracking-tighter text-red-500">404 ERROR</h1>
                        <div class="text-2xl font-bold tracking-tighter text-white lg:text-4xl">Halaman Tidak Ditemukan
                        </div>
