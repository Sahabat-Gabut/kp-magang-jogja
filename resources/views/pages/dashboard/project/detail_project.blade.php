<x-app-layout title="Detail Project">
    <div class="main-card">
        ...
        <div class="mt-10 border-t-2 pt-4">
            ...
            <div class="flex">
                @foreach ($team->apprentices as $key => $value)
                    <div class="flex mt-4 items-center mr-4">
                        <img src="{{ $value->imgSrc }}" class="h-14 w-14 rounded-full" />
                        <div class="flex flex-col ml-2">
                            <span class="font-semibold">{{ implode(' ', array_slice(explode(' ', $team->apprenticeUser[$key]->fullname), 0, 2))."\n" }}</span>
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 text-center bg-white text-sm">
                                    <div class="flex justify-center rounded-lg text-lg" role="group">
                                        <a href="/project/detail/{{ $team->id }}/{{ $project->id }}/{{ $value->id }}" class="bg-white text-gray-600 hover:bg-green-200 hover:text-green-600 border border-r-0 border-gray-300 rounded-l-md px-4 py-2 mx-0 outline-none">
                                        ...
                                        <a href="/project/detail/{{ $team->id }}/{{ $project->id }}/{{ $value->id }}/change" class="bg-white text-gray-600 hover:bg-yellow-200 hover:text-yellow-600 border border-gray-300  px-4 py-2 mx-0 outline-none">
