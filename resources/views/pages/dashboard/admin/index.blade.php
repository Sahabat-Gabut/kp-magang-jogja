                ...
                <tbody>
                    @foreach ($admin as $key => $a)
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                {{ $admin[$key]->adminDetail->fullname }}
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            ...
                            <td class="px-5 py-5 justify-center text-center border-b border-gray-200 bg-white text-sm">
                                <div class="flex justify-center rounded-lg text-lg" role="group">
                                    ...
                                    <a href="/admin/{{ $a->id }}/update" class="bg-white text-gray-600 hover:bg-yellow-200 hover:text-yellow-600 border border-gray-300  px-4 py-2 mx-0 outline-none focus:shadow-outline">
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>    
                                    </a>
                                    <a href="/admin/{{ $a->id }}/delete" class="bg-white text-gray-600 hover:bg-red-200 hover:text-red-600 border border-l-0 border-gray-300 rounded-r-md px-4 py-2 mx-0 outline-none focus:shadow-outline0">
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
